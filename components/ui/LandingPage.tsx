...
export function LandingPage() {
    return (
        <div className="min-h-screen font-sans text-amber-100 relative selection:bg-green-500/30">
            {/* Background */}
            <LivelyBackground />
            ...
            <section className="relative z-10 container mx-auto px-4 pt-32 pb-20 text-center flex flex-col items-center">
                ...
                <div className="flex flex-col sm:flex-row gap-4 w-full max-w-md">
                    {/* Since this is home, 'Start Farming Free' just scrolls or prompts login */}
                    <button
                        onClick={() => document.getElementById('pricing')?.scrollIntoView({ behavior: 'smooth' })} // Or trigger sign in? Usually "Start" = Sign In.
                        className="flex-1 bg-green-600 border-b-4 border-green-800 hover:bg-green-500 active:border-b-0 active:translate-y-1 transition-all py-4 rounded font-bold uppercase tracking-widest text-center shadow-lg shadow-green-900/50 text-white"
                    >
                        Start Farming Free
                    </button>
                    <Link href="#pricing" className="flex-1 bg-amber-800 border-b-4 border-amber-950 hover:bg-amber-700 active:border-b-0 active:translate-y-1 transition-all py-4 rounded font-bold uppercase tracking-widest text-center shadow-lg text-white">
                        View Plans
                    </Link>
                </div>

                {/* Mockup / Visual */}
                <div className="mt-20 relative w-full max-w-5xl aspect-video rounded-xl border-8 border-amber-950 shadow-2xl overflow-hidden group bg-black/50">
                    ...
                    {/* Placeholder for mockup image - forcing a specific image or using a div */}
                    <div className="w-full h-full bg-[url('/farm-bg.png')] bg-cover bg-center grayscale group-hover:grayscale-0 transition-all duration-700 scale-105 group-hover:scale-100" />
            ...
            <section id="pricing" className="relative z-10 py-20">
                <div className="container mx-auto px-4">
                    ...
                    <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
                        {/* Free Plan */}
                        <div className="bg-amber-900/20 border-4 border-amber-800/50 p-8 rounded-lg flex flex-col">
                            <h3 className="text-xl font-bold uppercase tracking-widest text-amber-300/60 mb-2">Seedling</h3>
                            <div className="text-4xl font-bold mb-6">$0 <span className="text-sm font-normal text-amber-400/40">/ forever</span></div>
                            ...
                            <button className="w-full py-3 border-2 border-amber-700 text-amber-300 font-bold uppercase text-xs tracking-widest hover:bg-amber-800 text-center transition-colors">
                                Start Free
                            </button>
                        </div>

                        {/* Pro Plan */}
                        <div className="bg-gradient-to-b from-amber-900/60 to-black/40 border-4 border-yellow-600/50 p-8 rounded-lg flex flex-col relative overflow-hidden">
                            ...
                            <div className="text-4xl font-bold mb-2">$4.99 <span className="text-sm font-normal text-amber-400/40">/ month</span></div>
                            <div className="text-xs text-amber-500/60 mb-6 font-mono">
                                or $50/year (Save ~17%)
                            </div>
                            <ul className="space-y-4 mb-8 flex-1">
                                <li className="flex items-center gap-3 text-sm text-amber-100"><CheckCircle className="w-4 h-4 text-yellow-400" /> Unlimited Gardens</li>
                                <li className="flex items-center gap-3 text-sm text-amber-100"><CheckCircle className="w-4 h-4 text-yellow-400" /> Legendary Companions (Dragons, Crystal Trees)</li>
                                <li className="flex items-center gap-3 text-sm text-amber-100"><CheckCircle className="w-4 h-4 text-yellow-400" /> Advanced Analytics</li>
                                <li className="flex items-center gap-3 text-sm text-amber-100"><CheckCircle className="w-4 h-4 text-yellow-400" /> Priority Support</li>
                            </ul>
                            <Link href="/upgrade" className="block w-full py-3 bg-yellow-600 border-b-4 border-yellow-800 text-black font-bold uppercase text-xs tracking-widest hover:bg-yellow-500 active:border-b-0 active:translate-y-1 transition-all text-center">
                                Upgrade to Pro
                            </Link>
                        </div>
                    </div>
